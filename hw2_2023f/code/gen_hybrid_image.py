...
def gen_hybrid_image(image1, image2, cutoff_frequency):
    ...
    ########################################################################
    alpha = 0.5  # You can adjust this value to control the blending
    beta = 1.0 - alpha

    # Linear blending of the two images
    hybrid_image = cv2.addWeighted(image1, alpha, image2, beta, 0.0)     # Your code here
