...
def hw2():
    ...
    image1 = cv2.imread('/Users/treblocami/Downloads/hw2_2023f/data/dog.bmp', -1) / 255.0
    image2 = cv2.imread('/Users/treblocami/Downloads/hw2_2023f/data/cat.bmp', -1) / 255.0
    ...
    cv2.imshow('high_frequencies + 0.5', high_frequencies)
    cv2.imshow('hybrid_image', hybrid_image)
    cv2.imshow('hybrid_image_scales', vis)

    result_dir = '/Users/treblocami/Downloads/hw2_2023f/result'
